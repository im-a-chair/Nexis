...
static inline NXS_Vec2 NXS_Vec2Mul(const NXS_Vec2 a, const NXS_Vec2 b) {
    NXS_Vec2 v = {
        .x = a.x * b.x,
        .y = a.y * b.y
    };
...
static inline NXS_Vec2 NXS_Vec2Div(const NXS_Vec2 a, const NXS_Vec2 b) {
    NXS_Vec2 v = {
        .x = a.x / b.x,
        .y = a.y / b.y
    };
...
static inline NXS_Vec2 NXS_Vec2Scale(const NXS_Vec2 v, float scalar) {
    NXS_Vec2 ret = {
        .x = v.x * scalar,
        .y = v.y * scalar
    };
...
static inline float NXS_Vec2Mag(const NXS_Vec2 v) {
    return sqrtf((v.x*v.x)+(v.y*v.y));
}
static inline NXS_Vec2 NXS_Vec2Norm(const NXS_Vec2 v) {
...
static inline NXS_Vec3 NXS_Vec3Mul(const NXS_Vec3 a, const NXS_Vec3 b) {
    NXS_Vec3 ret = {
        .x = a.x * b.x,
        .y = a.y * b.y,
        .z = a.z * b.z
...
static inline NXS_Vec3 NXS_Vec3Div(const NXS_Vec3 a, const NXS_Vec3 b) {
    NXS_Vec3 ret = {
        .x = a.x / b.x,
        .y = a.y / b.y,
        .z = a.z / b.z
...
static inline NXS_Vec3 NXS_Vec3Scale(const NXS_Vec3 v, float scalar) {
    NXS_Vec3 ret = {
        .x = v.x * scalar,
        .y = v.y * scalar,
        .z = v.z * scalar
...
static inline float NXS_Vec3Mag(const NXS_Vec3 v) {
    return sqrtf((v.x*v.x)+(v.y*v.y)+(v.z*v.z));
}
static inline NXS_Vec3 NXS_Vec3Norm(const NXS_Vec3 v) {
...
static inline NXS_Vec4 NXS_Vec4Mul(const NXS_Vec4 a, const NXS_Vec4 b) {
    NXS_Vec4 ret = {
        .x = a.x * b.x,
        .y = a.y * b.y,
        .z = a.z * b.z,
...
static inline NXS_Vec4 NXS_Vec4Div(const NXS_Vec4 a, const NXS_Vec4 b) {
    NXS_Vec4 ret = {
        .x = a.x / b.x,
        .y = a.y / b.y,
        .z = a.z / b.z,
...
static inline NXS_Vec4 NXS_Vec4Scale(const NXS_Vec4 v, float scalar) {
    NXS_Vec4 ret = {
        .x = v.x * scalar,
        .y = v.y * scalar,
        .z = v.z * scalar,
...
static inline float NXS_Vec4Mag(const NXS_Vec4 v) {
    return sqrtf((v.x*v.x)+(v.y*v.y)+(v.z*v.z)+(v.w*v.w));
}
static inline NXS_Vec4 NXS_Vec4Norm(const NXS_Vec4 v) {
